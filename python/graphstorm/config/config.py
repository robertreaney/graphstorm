...
# i have to add this here to allow my config yaml to select this loss function
BUILTIN_CLASS_LOSS_CROSS_ENTROPY_MASKED = "cross_entropy_masked"
BUILTIN_CLASS_LOSS_FOCAL = "focal"
BUILTIN_CLASS_LOSS_FUNCTION = [BUILTIN_CLASS_LOSS_CROSS_ENTROPY, BUILTIN_CLASS_LOSS_CROSS_ENTROPY_MASKED, BUILTIN_CLASS_LOSS_FOCAL]
